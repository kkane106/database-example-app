...
namespace :db do
  ...
  task :populate => :environment do
    ...
    # Seed PayType
    names = ["Grunt", "Troll", "Super", "unknown"]
    wage = [18000, 22000, 50000, 0]
    4.times do |n|
    ...
    # Seed AccountType
    discount = [10,25]
    account_type_names = ["loyalty", "friend"]
    2.times do |n|
      ...
      AccountType.create!(:account_type_code => account_type_code,
    ...
    product_category_names = ["bed","bath","kitchen","garage","living","dining"]
    6.times do |n|
    ...
    25.times do |n|
      ...
      tax_rate = 4.8
      POHeader.create!(:vendor_id    => vendor_id,
                       :store_number => store_number,
    ...
    250.times do |n|
      ...
      product_id = 1+rand(50)
      POItem.create!(:po_number  => po_number,
                     :quantity   => quantity,
                     :unit_cost  => unit_cost,
                     :product_id => product_id)
    end
    ...
    3.times do |n|
      ...
      50.times do |n|
        ...
        quantity_on_order = 0
        product_counter += 1
        Inventory.create!(:product_id        => product_id,
                          :store_number      => store_number,
    ...
    3.times do |n|
      ...
      store_number_counter += 1
      Store.create!(:manager_id     => manager_id,
                    :street         => street,
                    :city           => city,
                    :state          => state,
                    :zip            => zip,
